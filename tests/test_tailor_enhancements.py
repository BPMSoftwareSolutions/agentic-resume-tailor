...
from tailor import generate_docx_from_html, generate_jd_summary
...
class TestTailorIntegration(unittest.TestCase):
            ...
            "experience": [
                {
                    ...
                    "bullets": [
                        {
                            "text": "Built CI/CD pipelines with Python",
                            "tags": ["python", "ci/cd"],
                        },
                        {
                            "text": "Deployed AWS infrastructure",
                            "tags": ["aws", "cloud"],
                        },
    ...
    def test_tailor_scores_and_selects_bullets(self):
        ...
        self.assertIn(
            "ci/cd", scored[0]["text"].lower() + " ".join(scored[0]["tags"]).lower()
        )
