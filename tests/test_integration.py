...
from tailor import load_resume, render_markdown, select_and_rewrite
...
class TestEndToEndPipeline(unittest.TestCase):
            ...
            "experience": [
                {
                    ...
                    "bullets": [
                        ...
                        {"text": "Wrote documentation", "tags": ["Documentation"]},
                    ],
                }
            ],
            "education": [
    ...
    def test_complete_pipeline(self):
        ...
        tailored_experience = select_and_rewrite(
            resume_data["experience"], keywords, per_job=3
        )
        ...
        # Verify DOCX content (H1 name is skipped per template format, contact info removed from template)
    ...
    def test_top_bullets_selected(self):
        ...
        tailored = select_and_rewrite(
            self.resume_data["experience"], keywords, per_job=3
        )
