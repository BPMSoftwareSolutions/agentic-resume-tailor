...
def update_expertise(resume_data: Dict[str, Any], old_text: str, new_text: str) -> Dict[str, Any]:
    """
    Update/replace an expertise area.
...
def delete_expertise(resume_data: Dict[str, Any], text: str) -> Dict[str, Any]:
    ...
    resume_data["areas_of_expertise"] = [
        e for e in resume_data["areas_of_expertise"]
...
Examples:
  ...
  python src/crud/expertise.py --resume "Ford" --clear
    ...
    parser.add_argument(
        "--add",
        metavar="TEXT",
        help="Add new expertise area"
    )
    parser.add_argument(
        "--list",
        action="store_true",
        help="List all expertise areas"
    )
    parser.add_argument(
        "--update",
        nargs=2,
    ...
    parser.add_argument(
        "--delete",
        metavar="TEXT",
        help="Delete expertise area"
    )
    parser.add_argument(
        "--clear",
        action="store_true",
        help="Clear all expertise areas"
    )
    ...
    if not any(operations):
        parser.error("At least one operation (--add, --list, --update, --delete, --clear) must be specified")
