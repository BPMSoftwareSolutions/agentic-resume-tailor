...
def add_certification(
    ...
    cert_entry = {"name": name, "issuer": issuer, "date": date}
...
def find_certification_by_name(resume_data: Dict[str, Any], name: str) -> Optional[int]:
    """
...
def delete_certification(
    resume_data: Dict[str, Any], index: Optional[int] = None, name: Optional[str] = None
) -> Dict[str, Any]:
    """
...
Examples:
  ...
  python src/crud/certifications.py --resume "Ford" --delete --name "PSM I"
    ...
    # Operations
    parser.add_argument("--add", action="store_true", help="Add new certification")
    parser.add_argument("--list", action="store_true", help="List all certifications")
    parser.add_argument("--update", action="store_true", help="Update certification")
    parser.add_argument("--delete", action="store_true", help="Delete certification")
    ...
    try:
        ...
        if args.delete:
            resume_data = delete_certification(
                resume_data, index=args.index, name=args.name
            )
            modified = True
