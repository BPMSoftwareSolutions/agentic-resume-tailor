...
def update_achievement(resume_data: Dict[str, Any], old_text: str, new_text: str) -> Dict[str, Any]:
    """
    Update/replace an achievement.
...
def delete_achievement(resume_data: Dict[str, Any], text: str) -> Dict[str, Any]:
    ...
    resume_data["achievements"] = [
        a for a in resume_data["achievements"]
...
Examples:
  ...
  python src/crud/achievements.py --resume "Ford" --clear
    ...
    parser.add_argument(
        ...
        nargs=2,
        metavar=("OLD", "NEW"),
        help="Update/replace achievement"
    )
    parser.add_argument(
        "--delete",
        metavar="TEXT",
        help="Delete achievement"
    )
    parser.add_argument(
        "--clear",
        action="store_true",
        help="Clear all achievements"
    )
