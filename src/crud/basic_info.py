...
Examples:
  ...
  python src/crud/basic_info.py --resume "Ford" --show
    ...
    # Operations
    parser.add_argument("--update-name", metavar="NAME", help="Update name")
    parser.add_argument("--update-title", metavar="TITLE", help="Update title")
    parser.add_argument("--update-location", metavar="LOCATION", help="Update location")
    parser.add_argument("--update-email", metavar="EMAIL", help="Update email")
    parser.add_argument("--update-phone", metavar="PHONE", help="Update phone")
    parser.add_argument(
        "--show", action="store_true", help="Show current basic information"
    )
