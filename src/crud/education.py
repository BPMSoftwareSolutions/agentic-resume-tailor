...
def find_education_by_institution(
    resume_data: Dict[str, Any], institution: str
) -> Optional[int]:
    """
...
Examples:
  ...
  python src/crud/education.py --resume "Ford" --delete --institution "University of Phoenix"
    ...
    # Operations
    parser.add_argument("--add", action="store_true", help="Add new education entry")
    parser.add_argument(
        "--list", action="store_true", help="List all education entries"
    )
    parser.add_argument("--update", action="store_true", help="Update education entry")
    parser.add_argument("--delete", action="store_true", help="Delete education entry")
    ...
    try:
        ...
        if args.delete:
            resume_data = delete_education(
                resume_data, index=args.index, institution=args.institution
            )
            modified = True
